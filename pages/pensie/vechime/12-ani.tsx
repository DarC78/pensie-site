...
export default function DoisprezeceAniVechimePensiePage() {
  const pageUrl = 'https://dosarpensie.com/pensie/vechime/12-ani'
  const ogImage = 'https://dosarpensie.com/images/pensie-vechime-12-ani.jpg'

  const articleJsonLd = {
    '@context': 'https://schema.org',
    '@type': 'Article',
    headline: 'Cu 12 ani vechime pot să mă pensionez?',
    description:
      'Ghid complet despre pensia cu 12 ani vechime: ce spune legea, dacă există drept la pensie și ce soluții ai pentru completarea stagiului minim.',
    author: {
      '@type': 'Person',
      name: 'Adrian Defta',
  ...
  const faqJsonLd = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'Cu 12 ani vechime pot să mă pensionez?',
        acceptedAnswer: {
          '@type': 'Answer',
          text:
            'Nu. Cu 12 ani vechime nu este îndeplinit stagiul minim legal de 15 ani de cotizare necesar pentru pensia pentru limită de vârstă.',
        },
      },
      {
        '@type': 'Question',
        name: 'Există vreo pensie cu 12 ani vechime?',
        acceptedAnswer: {
          '@type': 'Answer',
          text:
  ...
  return (
    <>
      <Head>
        <title>Cu 12 ani vechime pot să mă pensionez? | DosarPensie</title>
        <link rel="canonical" href={pageUrl} />

        <meta
          name="description"
          content="Ai 12 ani vechime și te întrebi dacă te poți pensiona? Află ce spune legea și ce soluții există."
        />

        {/* Open Graph */}
        <meta property="og:type" content="article" />
        <meta property="og:title" content="Cu 12 ani vechime pot să mă pensionez?" />
        <meta
          property="og:description"
          content="Explicație clară despre situația pensiei cu 12 ani vechime și ce opțiuni ai."
        />
            ...
            <div className="section-container py-10 lg:py-14 grid lg:grid-cols-[3fr,2fr] gap-10">
              <div className="space-y-5">
                ...
                <h1 className="text-3xl lg:text-4xl font-bold text-slate-900 leading-tight">
                  Cu 12 ani vechime pot să mă pensionez?
                </h1>
                ...
                <p className="text-base lg:text-lg text-slate-700">
                  Mulți oameni ajung la 12 ani de vechime și se întreabă dacă acest nivel
                  este suficient pentru pensionare. În acest ghid explic clar situația
                  legală și ce soluții există.
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="section-container py-10 lg:py-14 space-y-10 text-slate-800">
              ...
              <section>
                <h2 className="text-xl lg:text-2xl font-bold mb-4">
                  2. Ce tip de pensie poți primi cu 12 ani
                </h2>
                <p className="mb-4">
                  Cu 12 ani vechime nu se acordă pensie publică.
                </p>
                <p className="mb-4">
              ...
              <section>
                <h2 className="text-xl lg:text-2xl font-bold mb-4">
                  3. De ce nu se acordă pensie cu 12 ani
                </h2>
                <p className="mb-4">
                  Pensia se bazează pe contribuții realizate pe termen lung.
                </p>
                <p className="mb-4">
                  12 ani de cotizare sunt insuficienți conform legii.
                </p>
                <p className="mb-4">
              ...
              <section>
                ...
                <p className="mb-4">
                  Cu 12 ani de cotizare nu se calculează pensia.
                </p>
                <p className="mb-4">
              ...
              <section>
                ...
                <p className="mb-4">
                  Cu 12 ani vechime nu există drept la pensie.
                </p>
                <p className="mb-4">
