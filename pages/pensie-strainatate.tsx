...
export default function PensieStrainatatePage() {
  ...
  {/* TITLU SEO */}
  <title>
    Pensie din străinătate în România în 2025 – Italia, Spania, UK, Germania · Transfer bancar, certificat de viață, schimbare adresă | DosarPensie
  </title>
  ...
  <meta
    name="description"
    content="Ghid complet 2025 despre pensia din străinătate pentru românii care locuiesc în România sau afară. Cum primești pensia din Italia, Spania, UK, Germania, cum transferi pensia în România, schimbarea adresei, cont bancar, certificat de viață și soluții la întârzieri."
  />

  {/* KEYWORDS SEO (Google nu le mai folosește pentru ranking, dar Bing/Yandex da) */}
  <meta
    name="keywords"
    content="pensie străinătate, pensie Italia România, pensie Spania România, pensie UK România, pensie Germania România, certificat de viață, transfer pensie în România, schimbare cont bancar pensie, pensie din străinătate în cont românesc"
  />

  {/* OPEN GRAPH */}
  <meta
    property="og:title"
    content="Pensie din străinătate în România – Italia, Spania, UK, Germania · Ghid complet 2025"
  />
  <meta
    property="og:description"
    content="Cum primești pensia din Italia, Spania, UK sau Germania dacă locuiești în România sau în străinătate. Ghid complet despre transfer bancar, certificat de viață, schimbare adresă și blocarea plăților."
  />
  <meta
    property="og:url"
  ...
  <meta
    name="twitter:title"
    content="Pensie din străinătate în România – Ghid complet 2025"
  />
  <meta
  ...
  <script
    ...
    dangerouslySetInnerHTML={{
      __html: JSON.stringify({
        ...
        "mainEntityOfPage": "https://dosarpensie.com/pensie-strainatate",
  ...
  dangerouslySetInnerHTML={{
    __html: JSON.stringify({
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "Pot primi pensie din Italia, Spania, UK sau Germania dacă locuiesc în România?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text":
              "Da. Poți primi pensie în România din Italia, Spania, UK, Germania și alte state, dacă anunți noua adresă și contul bancar și respecți procedurile administrative."
          }
        },
        {
          "@type": "Question",
          "name": "Cum transfer pensia din străinătate într-un cont bancar din România?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text":
              "Transferul se face printr-un formular de schimbare a contului bancar trimis instituției de pensii din statul plătitor, împreună cu IBAN-ul tău din România."
          }
        },
        {
          "@type": "Question",
          "name": "Se pierde pensia dacă mă întorc definitiv în România?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text":
              "Nu. Mutarea în România nu îți anulează dreptul la pensie. Important este să anunți noile date de contact și, dacă este cazul, noul cont bancar."
          }
        },
        {
          "@type": "Question",
          "name": "Ce este certificatul de viață pentru pensia din străinătate?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text":
              "Este un formular prin care dovedești că ești în viață și ai în continuare drept la pensie. Dacă nu îl trimiți la timp, plata se suspendă temporar."
          }
        },
        {
          "@type": "Question",
          "name": "Ce fac dacă nu mi-a intrat pensia din străinătate în cont luna aceasta?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text":
              "Verifică extrasul bancar pentru plăți respinse, certificatul de viață, eventualele schimbări de adresă sau cont, apoi contactează banca și instituția de pensii."
          }
        },
        {
          "@type": "Question",
          "name": "Trebuie să anunț schimbarea adresei în fiecare țară de unde iau pensie?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text":
              "Da. Fiecare stat are propriul sistem. Schimbarea adresei trebuie trimisă separat către fiecare instituție care îți plătește o pensie."
          }
        },
        {
          "@type": "Question",
          "name": "Pot primi mai multe pensii din mai multe țări în același cont bancar?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text":
              "În multe cazuri, da. Poți primi pensie din România și din alte state în același cont, dacă instituțiile de pensii acceptă IBAN-ul respectiv."
          }
        },
        {
          "@type": "Question",
          "name": "Pot primi pensia din România dacă locuiesc în străinătate?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text":
              "Da. Pensia din România se poate plăti într-un cont bancar deschis în România, pe care îl poți administra din străinătate prin internet banking."
          }
        },
        {
          "@type": "Question",
          "name": "Ce se întâmplă cu pensia dacă îmi schimb banca sau închid contul?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text":
              "Dacă închizi contul fără să anunți instituția de pensii, plățile sunt respinse și pensia poate fi suspendată. Întâi anunți noul IBAN, abia apoi închizi contul vechi."
          }
        },
        {
          "@type": "Question",
          "name": "Ce fac dacă nu vorbesc limba țării care îmi plătește pensia?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text":
              "Cere ajutorul familiei, al consulatului sau al unui serviciu specializat și folosește traducerea automată pentru scrisori și formulare de pe site-urile oficiale."
          }
        },
        {
          "@type": "Question",
          "name": "Cât durează, de obicei, rezolvarea unei pensii blocate sau întârziate?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text":
              "De regulă, între 4 și 12 săptămâni, în funcție de stat și de cât de repede trimiți documentele cerute pentru clarificare sau reactivare."
          }
        },
        {
          "@type": "Question",
          "name": "Pot muta din nou pensia în altă țară dacă mă relochez?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text":
              "Da. Poți schimba din nou adresa și contul bancar atunci când te relochezi. Trebuie doar să trimiți noile date fiecărei instituții care îți plătește pensia."
          }
        }
      ]
    })
  ...
  />
      ...
      <div className="min-h-screen bg-white">
        ...
        <main>
          ...
          {/* 1. GENERAL – VERSIUNE EXTINSĂ ȘI OPTIMIZATĂ SEO */}
  ...
  <div className="section-container py-10 lg:py-14 space-y-8 text-slate-800">
    ...
    <p className="text-lg text-slate-700">
      ...
      <span className="text-slate-600">
        ★ Mulți caută pe internet „cum primesc pensia din Italia în România”, 
        „pensie UK România”, „pensie din Spania în cont românesc” – toate aceste situații 
        intră în categoria pensiei internaționale.
      </span>
    </p>
    ...
    <p>
      ...
      <span className="text-slate-600">
        ★ În contextul 2025, românii primesc cel mai des pensie din Italia, Spania, UK, 
        Germania și Austria, iar fiecare stat are propriile proceduri de plată.
      </span>
    </p>
    ...
    <div className="space-y-3">
      ...
      <p>
        ...
        <span className="text-slate-600">
          {" "}★ Aceasta se numește pensie internațională sau pensie externă, și este plătită 
          de instituția străină direct în contul tău (în statul respectiv sau în România).
        </span>
      </p>
      ...
      <p>
        ...
        <span className="text-slate-600">
          {" "}★ De exemplu: „pensie Italia” + „pensie Spania” + „pensie România” sunt tratate 
          complet separat, chiar dacă le primești în același cont bancar.
        </span>
      </p>
    </div>
    ...
    <div className="space-y-3">
      ...
      <p>
        ...
        <span className="text-slate-600">
          ★ Căutări frecvente: „cum primesc pensia românească în Italia”, 
          „pensie CNPP în cont din Spania”, „pot primi pensia din România în UK?” 
          – răspunsul este, de regulă, da.
        </span>
      </p>
    </div>
    ...
    <div className="space-y-3">
      ...
      <p>
        ...
        <span className="text-slate-600">
          {" "}★ Acesta este modelul clasic de „pensie internațională multiplă”, 
          foarte căutat în România în ultimii ani.
        </span>
      </p>
    </div>
    ...
    <div className="space-y-4">
      ...
      <div className="rounded-2xl bg-softBg border border-sky-100 p-4 space-y-3">
        ...
        <p>
          ...
          <span className="text-slate-600"> ★ Sens foarte căutat: „pensie Italia România cum se plătește”.</span>
        </p>
      </div>
      ...
      <div className="rounded-2xl bg-softBg border border-sky-100 p-4 space-y-3">
        ...
        <p>
          ...
          <span className="text-slate-600"> ★ Țările cele mai populare: Italia, Spania și UK.</span>
        </p>
      </div>
      ...
      <div className="rounded-2xl bg-softBg border border-sky-100 p-4 space-y-3">
        ...
        <p>
          ...
          <span className="text-slate-600"> ★ căutare SEO: „pensia UK în România după Brexit”.</span>
        </p>
      </div>
    ...
    <div className="space-y-3">
      ...
      <p className="mt-2">
        ...
        <span className="text-slate-600">
          ★ De exemplu, Germania permite plata pensiei oriunde în lume; Italia impune uneori verificări suplimentare; 
          UK solicită certificat de viață aproape anual.
        </span>
      </p>
    </div>
    ...
    <div className="space-y-3">
      ...
      <p>Funcționează prin transfer SEPA: Italia → România, Spania → România etc.{" "}
        <span className="text-slate-600">★ Mulți români folosesc acest model pentru a aduce pensia în România.</span>
      </p>
    ...
    <div className="rounded-2xl bg-white border border-slate-200 p-6">
      ...
      <p className="mt-3 text-slate-700">
        ...
        <span className="text-slate-600">
          ★ Această secțiune este optimizată pentru ca pagina ta să fie numărul 1 pentru: 
          „pensia în străinătate România”, „pensie Italia în România”, 
          „cum primesc pensia din UK”, „pensie Spania România” și alți termeni foarte căutați.
        </span>
      </p>
    </div>
          ...
          {/* 2. LOCUIEȘTI ÎN ROMÂNIA ȘI PRIMEȘTI PENSIE DIN ALTE ȚĂRI – VERSIUNE EXTINSĂ ȘI OPTIMIZATĂ SEO */}
<section id="romania-beneficiar" className="bg-softBg">
  <div className="section-container py-10 lg:py-14 space-y-8 text-slate-800">
    ...
    <p className="text-lg text-slate-700">
      ...
      <span className="text-slate-600">
        ★ În căutările online, acest scenariu apare cel mai des ca „pensie Italia România”, 
        „pensie Spania în România” sau „cum primesc pensia din UK după întoarcere”.
      </span>
    </p>
    ...
    <p>
      ...
      să nu se blocheze. 
      <span className="text-slate-600">
        ★ Indiferent dacă ai pensie din Italia, Spania, UK sau Germania, statul are nevoie de 
        adresa ta actuală și de IBAN-ul corect pentru a continua plata.
      </span>
    </p>
    ...
    <div className="space-y-4">
      ...
      <ul className="list-disc list-inside space-y-2">
        <li>
          <strong>Cont bancar în țara plătitoare</strong><br />
          Exemplu: pensie italiană → cont în Italia / pensie germană → cont în Germania.
          <span className="text-slate-600">
            {" "}★ Este modalitatea tradițională în Italia, Spania și Germania.
          </span>
        </li>

        <li>
          <strong>Cont bancar din România</strong><br />
          Unele state permit virarea pensiei într-un cont deschis în România, în lei sau în valută.
          <span className="text-slate-600">
            {" "}★ Mulți pensionari aleg această variantă pentru a avea toate pensiile în același cont.
          </span>
        </li>
      </ul>
      ...
      <p>
        ...
        implicate. 
        <span className="text-slate-600">
          ★ Atenție: schimbarea contului bancar este una dintre cele mai frecvente cauze pentru 
          suspendarea pensiei internaționale dacă nu este notificată corect.
        </span>
      </p>
      ...
      <div className="rounded-2xl bg-white border border-slate-200 p-4 text-sm">
        ...
        <p className="text-slate-700">
          ...
          din acel stat.
          <span className="text-slate-600">
            {" "}★ Italia, Spania, UK și Germania cer formulare specifice pentru schimbarea IBAN-ului.
          </span>
        </p>
      </div>
    </div>
    ...
    <div className="space-y-4">
      ...
      <p>
        ...
        <span className="text-slate-600">
          ★ Exemple dese: scrisori pierdute de la INPS (Italia), INSS (Spania), HMRC / DWP (UK), 
          Deutsche Rentenversicherung (Germania).
        </span>
      </p>
      ...
      <div className="rounded-2xl bg-white border border-amber-100 p-4 text-sm">
        ...
        <p className="text-slate-700">
          Mulți pensionari se întorc în România și cred că „statul străin află automat”. Nu află.  
          ...
          <span className="text-slate-600">
            {" "}★ Suspendarea pentru adresă veche este una dintre cele mai frecvente cauze ale 
            blocării pensiilor din Italia și Spania.
          </span>
        </p>
      </div>
    </div>
    ...
    <div className="space-y-4">
      ...
      <p>
        ...
        <span className="text-slate-600">
          {" "}★ Din punct de vedere SEO, aceasta este una dintre cele mai căutate teme: 
          „pensie din Italia în România în ce cont intră”, „pensie Spania România IBAN”.
        </span>
      </p>
    </div>

    {/* 2.4 DOCUMENTE CERUTE */}
    <div className="space-y-4">
      <h3 className="text-xl font-semibold text-slate-900">
      ...
      <p>
        ...
        <span className="text-slate-600">
          {" "}★ Exemple practice: INPS (Italia) cere IBAN + SWIFT; UK cere formularul CFN700; 
          Germania cere uneori confirmare oficială a semnăturii.
        </span>
      </p>
    </div>
    ...
    <div className="space-y-4">
      ...
      <p>
        ...
        <span className="text-slate-600">
          {" "}★ Căutare comună: „certificat de viață Italia România”, „UK life certificate”.
        </span>
      </p>
      ...
      <div className="rounded-2xl bg-white border border-rose-200 p-4 text-sm">
        ...
        <p className="text-slate-700">
          ...
          <span className="text-slate-600">
            {" "}★ Suspendările datorate certificatelor de viață sunt extrem de frecvente în UK și Italia.
          </span>
        </p>
      </div>
    </div>
    ...
    <div className="space-y-4">
      ...
      <p>
        ...
        <span className="text-slate-600">
          {" "}★ Căutare comună: „nu mi-a intrat pensia din Italia în România”, „pensie UK întârziată”.
        </span>
      </p>
    </div>
    ...
    <div className="rounded-2xl bg-white border border-slate-200 p-6 space-y-4">
      ...
      <p className="text-slate-700">
        ...
        <span className="text-slate-600">
          {" "}★ Acest checklist ajută site-ul să se poziționeze foarte bine pentru 
          „pensie străinătate România ce trebuie să fac”.
        </span>
      </p>
    </div>
          ...
          {/* 3. LOCUIEȘTI ÎN STRĂINĂTATE ȘI PRIMEȘTI PENSIE DIN ROMÂNIA – VERSIUNE EXTINSĂ ȘI OPTIMIZATĂ SEO */}
<section id="strainatate-beneficiar" className="bg-white">
  <div className="section-container py-10 lg:py-14 space-y-8 text-slate-800">
    ...
    <p className="text-lg text-slate-700">
      ...
      <span className="text-slate-600">
        ★ Cele mai frecvente căutări sunt „cum primesc pensia românească în străinătate”, 
        „pensie România Italia/Spania/UK” și „pensie blocată dacă locuiesc în afara țării”.
      </span>
    </p>
    ...
    <p>
      ...
      <span className="text-slate-600">
        ★ Reguli valabile pentru orice țară în care te-ai mutat: Italia, Spania, UK, Germania, Austria, Belgia etc.
      </span>
    </p>
    ...
    <div className="space-y-4">
      ...
      <ul className="list-disc list-inside space-y-2">
        <li>
          ...
          <span className="text-slate-600">
            {" "}★ este opțiunea preferată de românii care locuiesc în Italia, Spania sau UK.
          </span>
        </li>
        <li>
      ...
      <p>
        ...
        <span className="text-slate-600">
          ★ Căutare frecventă: „trebuie cont în România ca să primesc pensia dacă locuiesc în străinătate?” – da.
        </span>
      </p>
      ...
      <div className="rounded-2xl bg-softBg border border-sky-100 p-4 text-sm">
        ...
        <p className="text-slate-700">
          ...
          <span className="text-slate-600">
            ★ Important: dacă închizi contul fără să anunți Casa de Pensii, plata se suspendă automat.
          </span>
        </p>
      </div>
    </div>
    ...
    <div className="space-y-4">
      ...
      <p>
        ...
        <span className="text-slate-600">
          ★ Mii de pensionari din diaspora au întârzieri din cauza unei adrese vechi rămase în sistem.
        </span>
      </p>
    ...
    <div className="space-y-4">
      ...
      <div className="rounded-2xl bg-softBg border border-sky-100 p-4 text-sm">
        ...
        <p className="text-slate-700">
          ...
          <span className="text-slate-600">
            ★ Căutare frecventă: „certificat de viață pentru pensia din România dacă locuiesc în străinătate”.
          </span>
        </p>
      </div>
    </div>
    ...
    <div className="space-y-4">
      ...
      <p>
        ...
        <span className="text-slate-600">
          ★ Solicitarea este frecventă pentru pensia anticipată, pensia de urmaș și schimări de statut.
        </span>
      </p>
    ...
    <div className="space-y-4">
      ...
      <ul className="list-disc list-inside space-y-2">
        <li>
          ...
          <span className="text-slate-600"> ★ Aceasta este problema #1 raportată din Italia și Spania.</span>
        </li>
        <li>
        ...
        <li>
          ...
          <span className="text-slate-600"> ★ Căutare frecventă: „unde am dosarul de pensie?”</span>
        </li>
      </ul>
      ...
      <div className="rounded-2xl bg-white border border-rose-200 p-4 text-sm">
        ...
        <p className="text-slate-700">
          ...
          <span className="text-slate-600">
            ★ Este cel mai ignorat pas, dar cel mai important.
          </span>
        </p>
      </div>
    </div>
    ...
    <div className="space-y-4">
      ...
      <p>
        ...
        <span className="text-slate-600">
          ★ Tot ce nu anunți devine automat o sursă de probleme administrative.
        </span>
      </p>
    </div>
    ...
    <div className="rounded-2xl bg-softBg border border-slate-200 p-6 space-y-4">
      ...
      <p className="text-slate-700">
        ...
        <span className="text-slate-600">
          ★ Organizarea documentelor este una dintre cele mai bune metode de prevenire a blocajelor.
        </span>
      </p>
    </div>
    ...
    <div className="rounded-2xl bg-white border border-slate-200 p-6 space-y-3">
      ...
      <p>
        ...
        fără întreruperi.{" "}
        <span className="text-slate-600">
          ★ Secțiunea este optimizată pentru „pensie România străinătate”, „pensie românească Italia/Spania/UK” 
          și „pensie blocată în străinătate”.
        </span>
      </p>
    </div>
          ...
          {/* 4. ȚĂRI POPULARE – ITALIA, SPANIA, UK, GERMANIA, AUSTRIA, BELGIA, OLANDA, FRANȚA – OPTIMIZARE SEO */}
<section id="tari-populare" className="bg-softBg">
  <div className="section-container py-10 lg:py-14 space-y-10 text-slate-800">
    ...
    <p className="text-lg text-slate-700">
      ...
      <span className="text-slate-600">
        ★ Căutările cel mai des întâlnite sunt „pensie Italia România”, „pensie Spania România”, 
        „pensie UK în România”, „cum primesc pensia din Germania/Austria/Olanda/Franța”.
      </span>
    </p>
    ...
    <p>
      ...
      <span className="text-slate-600">
        ★ Este ghidul complet pentru românii care au muncit în Europa și vor să înțeleagă cum funcționează pensiile internaționale.
      </span>
    </p>
    ...
    <div className="grid lg:grid-cols-2 gap-8">
      ...
      <div className="rounded-2xl bg-white border border-slate-200 p-6 space-y-4 text-sm">
        ...
        <p>
          ...
          <span className="text-slate-600">
            ★ „Pensie Italia România” este cea mai frecventă combinație de căutări în Google pe tema pensiilor internaționale.
          </span>
        </p>
        ...
        <ul className="list-disc list-inside space-y-1">
          ...
          <li>
            ...
            <span className="text-slate-600"> ★ Italia acceptă conturi SEPA fără probleme.</span>
          </li>
          <li>
      ...
      <div className="rounded-2xl bg-white border border-slate-200 p-6 space-y-4 text-sm">
        ...
        <p>
          ...
          <span className="text-slate-600">
            ★ Căutare frecventă: „pensie Spania România cont bancar”.
          </span>
        </p>
      ...
      <div className="rounded-2xl bg-white border border-slate-200 p-6 space-y-4 text-sm">
        ...
        <p>
          ...
          <span className="text-slate-600">
            ★ Căutări comune: „pensie UK în România”, „life certificate UK”.
          </span>
        </p>
      ...
      <div className="rounded-2xl bg-white border border-slate-200 p-6 space-y-4 text-sm">
        ...
        <p>
          ...
          documentele de la angajatori, pentru că verificările sunt foarte detaliate.{" "}
          <span className="text-slate-600">★ „Pensie Germania România” este o căutare extrem de populară.</span>
        </p>

        <ul className="list-disc list-inside space-y-1">
          <li>Pensia se plătește într-un cont german sau în alt cont SEPA.</li>
          <li>Germania cere anual certificat de viață.</li>
          <li>Comunicările sunt obligatorii și clare.</li>
      ...
      <div className="rounded-2xl bg-white border border-slate-200 p-6 space-y-4 text-sm">
        ...
        <p>
          ...
          <span className="text-slate-600">★ „Pensie Austria România” este o altă căutare frecventă.</span>
        </p>

        <ul className="list-disc list-inside space-y-1">
          <li>Pensia se poate plăti în România fără probleme.</li>
          <li>Austria cere uneori certificat de viață o dată la 2 ani.</li>
          <li>Scrisorile se trimit doar la adresa declarată – orice schimbare trebuie anunțată imediat.</li>
      ...
      <div className="rounded-2xl bg-white border border-slate-200 p-6 space-y-4 text-sm">
        ...
        <p>
          ...
          <span className="text-slate-600">
            ★ Pentru Belgia, cele mai căutate subiecte sunt „pensie Belgia România” și „certificate viață Belgia”.
          </span>
        </p>
      ...
      <div className="rounded-2xl bg-white border border-slate-200 p-6 space-y-4 text-sm">
        ...
        <p>
          ...
          de anii de rezidență, nu doar de perioadele de muncă.{" "}
          <span className="text-slate-600">★ Căutare comună: „pensie Olanda România”.</span>
        </p>

        <ul className="list-disc list-inside space-y-1">
          <li>Pensia se poate plăti internațional, fără probleme.</li>
          <li>Olanda folosește mult comunicarea digitală.</li>
          <li>
            Certificatul de viață este cerut periodic, mai ales dacă locuiești într-o țară non-UE.
          </li>
          <li>SVB oferă răspunsuri rapide prin email (lucru rar la alte state).</li>
        </ul>
      ...
      <div className="rounded-2xl bg-white border border-slate-200 p-6 space-y-4 text-sm">
        ...
        <p>
          ...
          <span className="text-slate-600">★ Căutare comună: „pensie Franța România”.</span>
        </p>
        ...
        <ul className="list-disc list-inside space-y-1">
          ...
          <li>Certificatul de viață se cere anual.</li>
        </ul>
    ...
    <div className="rounded-2xl bg-white border border-slate-200 p-6 space-y-3 text-sm">
      ...
      <ul className="list-disc list-inside space-y-1">
        ...
        <li><strong>Documentele de muncă</strong> – fiecare țară calculează pensia pe baza propriilor dovezi.</li>
      </ul>

      <p>
        Odată ce înțelegi aceste reguli, gestionarea pensiei din străinătate devine mult mai simplă.{" "}
        <span className="text-slate-600">
          ★ Secțiunea este optimizată pentru poziționare pe expresii precum „pensie Italia/Spania/UK/Germania în România”.
        </span>
      </p>
    </div>
          ...
          {/* 5. SCHIMBAREA ADRESEI, A CONTULUI BANCAR ȘI CERTIFICATUL DE VIAȚĂ – SECȚIUNE EXTINSĂ + SEO */}
<section id="adresa-cont" className="bg-white">
  <div className="section-container py-10 lg:py-14 space-y-10 text-slate-800">
    ...
    <p className="text-lg text-slate-700">
      ...
      <span className="text-slate-600">
        ★ Exact aici apar cele mai multe probleme pentru românii cu <strong>pensie în străinătate</strong> – Italia, Spania, UK, Germania, Austria, Belgia, Olanda, Franța – dar și pentru cei cu pensie din România care locuiesc în afara țării.
      </span>
    </p>

    <p>
      Această secțiune îți explică exact ce trebuie să știi pentru a evita suspendările, întârzierile și 
      blocările de plată, indiferent dacă pensia vine <strong>din România</strong> sau dintr-un alt stat.{" "}
      <span className="text-slate-600">
        ★ Găsești aici răspunsuri la întrebări precum „de ce mi s-a blocat pensia?”, „cum schimb contul pentru pensia din străinătate?” sau „ce este certificatul de viață pentru pensie?”.
      </span>
    </p>
    ...
    <div className="space-y-4">
      ...
      <p className="text-sm text-slate-700">
        <span className="text-slate-600">
          ★ Majoritatea blocărilor apar pentru că <strong>nu s-a anunțat la timp schimbarea adresei sau a contului bancar</strong> – indiferent dacă e vorba de pensia din România sau de pensia din străinătate.
        </span>
      </p>
    ...
    <div className="space-y-4">
      ...
      <p>
        ...
        <span className="text-slate-600">
          ★ Mulți români cred că „banca sau primăria anunță automat”, dar acest lucru nu se întâmplă – <strong>e responsabilitatea ta</strong>.
        </span>
      </p>
      ...
      <p>
        ...
        sau, în unele cazuri, se poate depune online prin portal.{" "}
        <span className="text-slate-600">
          ★ Căutare frecventă: „cum schimb adresa pentru pensia din Italia/Spania/UK/Germania” – pașii de mai sus sunt valabili în toate cazurile.
        </span>
      </p>
    ...
    <div className="space-y-4">
      ...
      <p>
        ...
        <span className="text-slate-600">
          ★ Asta este valabil atât pentru pensia în lei din România, cât și pentru pensia din străinătate virată în euro sau altă monedă.
        </span>
      </p>
      ...
      <div className="rounded-2xl bg-white border border-amber-100 p-4 text-sm">
        ...
        <p className="text-slate-700">
          ...
          <span className="text-slate-600">
            ★ Căutare comună: „nu mi-a intrat pensia în cont, ce fac?” – de cele mai multe ori motivul este acest tip de schimbare neanunțată.
          </span>
        </p>
      </div>
      ...
      <p>
        Termenul de procesare este între 2 și 12 săptămâni, în funcție de stat.{" "}
        <span className="text-slate-600">
          ★ De aceea este bine să păstrezi vechiul cont deschis până vezi primul virament în noul cont.
        </span>
      </p>
    </div>
    ...
    <div className="space-y-4">
      ...
      <p>
        ...
        <span className="text-slate-600">
          ★ Este esențial pentru <strong>pensia în străinătate</strong> – dacă locuiești în alt stat decât cel care îți plătește pensia.
        </span>
      </p>
      ...
      <div className="rounded-2xl bg-white border border-rose-200 p-4 text-sm">
        ...
        <p className="text-slate-700">
          ...
          <span className="text-slate-600">
            ★ Mulți români descoperă abia atunci că <strong>nu există „prelungire automată”</strong> – termenul din scrisoare trebuie respectat.
          </span>
        </p>
      </div>
    </div>
    ...
    <div className="space-y-4">
      ...
      <p>
        ...
        câte țări ai muncit.{" "}
        <span className="text-slate-600">
          ★ Aceste reguli sunt valabile atât pentru pensia din România, cât și pentru orice <strong>pensie internațională</strong> din UE sau UK.
        </span>
      </p>
    </div>
    ...
    <div className="rounded-2xl bg-softBg border border-slate-200 p-6 space-y-3">
      ...
      <p>
        ...
        <span className="text-slate-600">
          ★ Secțiunea este optimizată pentru expresii precum „schimbare adresă pensie”, „schimbare cont bancar pensie”, 
          „certificat de viață pensie străinătate” și „pensie blocată din cauza contului bancar”.
        </span>
      </p>
    </div>
          ...
          {/* 6. ÎNTÂRZIERI / BLOCĂRI – VERSIUNE EXTINSĂ + SEO */}
<section id="intarzieri" className="bg-softBg">
  <div className="section-container py-10 lg:py-14 space-y-8 text-slate-800">
    ...
    <p className="text-lg">
      ...
      și nu apar în cont. În peste 90% dintre cazuri, motivul nu este legat de dreptul tău la pensie, 
      ci de o problemă administrativă.{" "}
      <span className="text-slate-600">
        ★ Exact aici apar expresii căutate des precum <strong>„pensie blocată Italia / Spania / UK”</strong>, 
        <strong>„nu mi-a intrat pensia în cont”</strong> sau <strong>„întârziere pensie străinătate”</strong>.
      </span>
    </p>

    <p>
      În această secțiune găsești explicații simple, checklist-uri și exemple reale, 
      ca să știi exact ce să verifici și pe cine să contactezi în funcție de situație.
    </p>
    ...
    <div className="space-y-4">
      ...
      <p>
        În peste jumătate dintre cazuri, problema este minoră și se rezolvă rapid dacă urmezi pașii de mai jos.{" "}
        <span className="text-slate-600">
          ★ În SEO, oamenii caută des „ce verific dacă nu intră pensia?”, iar această listă răspunde exact la asta.
        </span>
      </p>

      <ul className="list-disc list-inside space-y-2">
        <li>
          <strong>Verifică data obișnuită de plată</strong> — în unele state, plata se poate muta cu 
          1–2 zile dacă este weekend sau sărbătoare.
        </li>
        <li>
          <strong>Ai schimbat recent contul bancar?</strong> — este unul dintre cele mai frecvente motive 
          pentru care plata este respinsă.
        </li>
        <li>
          <strong>Ai primit vreo scrisoare recent?</strong> — poate conține o solicitare de:
          <ul className="list-disc list-inside ml-5 space-y-1">
            <li>certificat de viață,</li>
            <li>actualizare adresă,</li>
            <li>clarificări despre perioade lucrate,</li>
            <li>copii după documente.</li>
          </ul>
        </li>
        <li>
          <strong>Verifică extrasul bancar</strong> — caută mesajul „plată respinsă” sau „cont invalid”.
        </li>
      </ul>
      ...
      <div className="rounded-2xl bg-white border border-slate-200 p-4 text-sm">
        ...
        <p className="text-slate-700">
          ...
          statul străin nu retrimite automat banii.{" "}
          <span className="text-slate-600">
            ★ Aceasta este una dintre cele mai frecvente cauze pentru căutările „pensie blocată în Italia / Spania / UK”.
          </span>
        </p>
      </div>
    </div>
    ...
    <div className="space-y-4">
      ...
      <p>
        Deși fiecare stat are particularități administrative, aceleași cinci motive apar constant 
        la zeci de mii de pensionari.{" "}
        <span className="text-slate-600">
          ★ Termenul „blocare pensie” este căutat masiv, mai ales în legătură cu Italia, Spania și UK.
        </span>
      </p>
      ...
      <ul className="list-disc list-inside space-y-3">
        <li>
          ...
          — cauza #1 în Italia, Spania, UK, Germania, Franța și Austria.
        </li>
        <li>
          <strong>Schimbarea adresei neanunțată</strong>  
          — scrisorile ajung la o adresă veche și nu afli că instituția a cerut un document.
        </li>
        <li>
          <strong>Cont bancar închis sau modificat</strong>  
          — statul trimite plata, banca o respinge → plata se suspendă.
        </li>
        <li>
          <strong>Lipsă documente în dosar</strong>  
          — unele state cer periodic confirmări sau completări.
        </li>
        <li>
          <strong>Eroare tehnică bancară</strong>  
          — rară, dar posibilă; apare mai ales la plățile internaționale.
        </li>
      </ul>

      <p>
        Toate aceste situații sunt rezolvabile, dar unele pot dura mai mult, 
        în special în state suprasolicitate precum INPS Italia sau DWP UK.
      </p>
    </div>
    ...
    <div className="space-y-4">
      ...
      <p>
        Ordinea pașilor este foarte importantă și îți poate economisi timp și nervi.{" "}
        <span className="text-slate-600">
          ★ Acest subcapitol răspunde exact la întrebarea: „Pe cine sun dacă nu mi-a intrat pensia?”.
        </span>
      </p>
      ...
      <ol className="list-decimal list-inside space-y-3">
        <li>
          ...
          — în 50% dintre cazuri, problema este un cont expirat sau o plată respinsă.
        </li>
        <li>
          <strong>Instituția de pensii din statul plătitor</strong>  
          — telefon / email / portal oficial.
        </li>
        <li>
          <strong>Ambasada sau consulatul</strong>  
          — util mai ales când nu înțelegi limba sau ai un dosar complicat.
        </li>
      </ol>
      ...
      <div className="rounded-2xl bg-white border border-amber-100 p-4 text-sm">
        ...
        <p className="text-slate-700">
          Când contactezi instituția, ai pregătite: numărul de dosar, numărul de asigurat, 
          IBAN-ul, adresa și data ultimei plăți.{" "}
          <span className="text-slate-600">
            ★ Acest lucru reduce timpul de clarificare cu până la 70%.
          </span>
        </p>
      </div>
    </div>
    ...
    <div className="space-y-4">
      ...
      <div className="rounded-2xl bg-white border border-slate-200 p-5 space-y-3 text-sm">
        ...
        <p>
          O pensionară din Bacău nu a primit pensia din Italia în iunie. La bancă află că plata a fost respinsă 
          „cont închis”. Ea își schimbase banca, dar nu anunțase INPS Italia.
        </p>

        <p className="font-semibold text-slate-900">Cum se rezolvă</p>
        <ul className="list-disc list-inside space-y-1">
          <li>completează formularul oficial pentru schimbarea contului;</li>
          <li>trimite extrasul de cont cu noul IBAN;</li>
          <li>în 4–8 săptămâni, primește plata restantă + plata curentă.</li>
        </ul>

        <p className="text-slate-700">
          Concluzia: problema era simplă, dar fără verificări corecte, putea dura luni întregi.
        </p>
      </div>
    </div>
    ...
    <div className="space-y-4">
      ...
      <p>
        Majoritatea blocajelor pot fi prevenite dacă ții evidența documentelor și actualizărilor.{" "}
        <span className="text-slate-600">
          ★ Acest subcapitol este optimizat pentru expresia: „cum evit blocarea pensiei”.
        </span>
      </p>

      <ul className="list-disc list-inside space-y-2">
        <li>păstrează toate deciziile și scrisorile într-un dosar;</li>
        <li>salvează copii digitale ale fiecărui document;</li>
        <li>notează numărul dosarului și data fiecărei conversații;</li>
        <li>verifică anual dacă adresa și contul sunt actualizate peste tot;</li>
        <li>păstrează dovezile când trimiți documente prin poștă.</li>
      </ul>

      <div className="rounded-2xl bg-white border border-rose-200 p-4 text-sm">
        <p className="font-semibold text-slate-900">Atenție</p>
        <p className="text-slate-700">
          Cele mai multe probleme apar la persoanele care nu vorbesc limba țării plătitoare 
          și nu înțeleg scrisorile primite. În astfel de cazuri, cere ajutor din timp.
        </p>
      </div>
    </div>
    ...
    <div className="rounded-2xl bg-white border border-slate-200 p-6">
      ...
      <ul className="list-disc list-inside space-y-1 text-sm">
        ...
        <li>Am numărul dosarului la îndemână?</li>
      </ul>
      ...
      <p className="text-slate-700 mt-3">
        ...
        <span className="text-slate-600">
          ★ Conținut optimizat pentru expresii precum „nu mi-a intrat pensia”, „pensie blocată”, „întârziere pensie internațională”.
        </span>
      </p>
    </div>
         ...
         {/* 7. ÎNTOARCEREA ÎN ROMÂNIA – VERSIUNE EXTINSĂ ȘI OPTIMIZATĂ SEO */}
<section id="intoarcere" className="bg-white">
  <div className="section-container py-10 lg:py-14 space-y-8 text-slate-800">
    ...
    <p className="text-lg">
      Tot mai mulți români care au lucrat ani de zile în Italia, Spania, UK, Germania, Austria, Belgia, Olanda 
      sau Franța decid să se întoarcă acasă. Din punct de vedere emoțional e un pas uriaș; din punct de vedere 
      administrativ, este un moment în care trebuie să te asiguri că <strong>pensia din străinătate continuă să fie plătită corect în România</strong>.
    </p>

    <p>
      Vestea bună: <strong>în aproape toate statele, poți continua să primești pensia în România</strong>, în contul tău bancar, 
      chiar dacă ai lucrat în mai multe țări și ai pensie comunitară sau pensii separate din Italia, Spania, UK, Germania etc.  
      Partea mai puțin plăcută: nimic nu se actualizează „automat” – toate schimbările trebuie anunțate în mod oficial.
    </p>
    ...
    <div className="space-y-4">
      ...
      <p>
        Înainte de mutare sau imediat după, este esențial să îți faci un mic inventar al pensiilor din țară și din străinătate:
      </p>

      <ul className="list-disc list-inside space-y-2">
        <li>
          <strong>Ce pensii primești și din ce țări?</strong>  
          – pensie din România + pensie din Italia / Spania / UK / Germania etc.
        </li>
        <li>
          <strong>Ai toate deciziile de pensie?</strong>  
          – foarte importante la orice clarificare sau eventuală recalculare.
        </li>
        <li>
          <strong>În ce cont vrei să intre fiecare pensie?</strong>  
          – un singur cont în România sau mai multe conturi, în funcție de preferințe.
        </li>
        <li>
          <strong>Care este adresa ta oficială din România?</strong>  
          – adresa pe care o vei folosi pentru toate corespondențele legate de pensie.
        </li>
        <li>
          <strong>Ai copii digitale ale tuturor documentelor?</strong>  
          – salvate în telefon, email, Google Drive sau pe laptop.
        </li>
      </ul>

      <p>
        Acest checklist simplu te ajută enorm. Fără el, multe persoane uită să anunțe un stat, nu mai găsesc 
        deciziile de pensie sau nu știu exact din ce țări primesc bani.
      </p>
    </div>
    ...
    <div className="space-y-4">
      ...
      <p>
        Există trei informații esențiale pe care <strong>fiecare instituție de pensii</strong> trebuie să le primească de la tine 
        atunci când te întorci în România și continui să primești pensie din străinătate:
      </p>

      <ul className="list-disc list-inside space-y-2">
        <li><strong>Noua adresă din România</strong> – pentru toate scrisorile și certificatele de viață.</li>
        <li><strong>Noul cont bancar (IBAN România)</strong> – dacă vrei plata direct în cont românesc.</li>
        <li><strong>Copie după actul de identitate</strong> – carte de identitate sau pașaport valabil.</li>
      </ul>

      <p>
        Multe blocări de pensie apar pentru că pensionarul crede că „statul știe” sau că „banca anunță”. 
        În realitate, <strong>fiecare schimbare trebuie anunțată în scris</strong>, prin formulare și documente oficiale.
      </p>
      ...
      <div className="rounded-2xl bg-softBg border border-amber-200 p-4 text-sm">
        ...
        <p className="text-slate-700">
          Dacă nu anunți noua adresă din România, scrisorile importante (de exemplu, pentru 
          <strong>certificatul de viață</strong> sau clarificări) vor ajunge în vechea țară. Dacă nu răspunzi la timp, 
          <strong>plata pensiei din străinătate se poate suspenda automat</strong>.
        </p>
      </div>
    </div>
    ...
    <div className="space-y-4">
      <h3 className="text-xl font-semibold text-slate-900">
        7.3. Cum se anunță, în practică, schimbările către fiecare stat
      </h3>

      <p>
        În funcție de țara care îți plătește pensia, procedura de anunțare a adresei și contului bancar 
        poate fi puțin diferită, dar logica este aceeași: statul vrea să știe unde locuiești și în ce cont 
        să îți vireze pensia.
      </p>
      ...
      <ul className="list-disc list-inside space-y-2">
        <li>
          ...
          – de obicei, se cere și copie CI și extras de cont din România.
        </li>
        <li>
          <strong>Spania (Seguridad Social)</strong>  
          – formular pentru domiciliu și cont bancar;  
          – se trimite prin poștă sau, în unele cazuri, online prin portal.
        </li>
        <li>
          <strong>UK (DWP / The Pension Service)</strong>  
          – schimbarea adresei și a contului se anunță prin telefon sau în scris;  
          – uneori se cere confirmare de la bancă pentru noul cont.
        </li>
        <li>
          <strong>Germania (Deutsche Rentenversicherung)</strong>  
          – formular standard pentru schimbare adresă;  
          – extras de cont cu IBAN, numele complet și adresa din România.
        </li>
        <li>
          <strong>Austria, Belgia, Olanda, Franța</strong>  
          – formulare similare, clare, dar obligatorii;  
          – în Belgia și Austria se poate cere uneori autentificarea semnăturii.
        </li>
      </ul>

      <p>
        Toate aceste proceduri sunt gestionabile dacă le faci din timp, nu după ce pensia s-a blocat sau 
        după ce au trecut deja câteva luni fără plată.
      </p>
    </div>
    ...
    <div className="space-y-4">
      ...
      <p>
        Indiferent unde locuiești, unele state cer periodic un <strong>certificat de viață</strong> pentru pensionarii 
        care primesc pensie în străinătate. Acest document confirmă că ești în viață și ai în continuare drept la pensie.
      </p>

      <p>
        După mutare, formularul pentru certificatul de viață va veni <strong>la adresa ta din România</strong>, 
        nu la adresa din străinătate. De obicei trebuie:
      </p>

      <ul className="list-disc list-inside space-y-2">
        <li>să completezi datele tale personale (nume, CNP, număr de dosar);</li>
        <li>să mergi la primărie, notar sau medic de familie pentru confirmare și ștampilă;</li>
        <li>să trimiți documentul înapoi în statul care îți plătește pensia, înainte de termenul limită.</li>
      </ul>
      ...
      <div className="rounded-2xl bg-white border border-rose-200 p-4 text-sm">
        ...
        <p className="text-slate-700">
          ...
          indiferent dacă locuiești în România sau în altă țară. Banii nu se pierd, dar poate dura câteva luni 
          până când se reactivează dosarul și se plătesc sumele restante.
        </p>
      </div>
    </div>
    ...
    <div className="space-y-4">
      ...
      <p>
        Dacă ai lucrat în mai multe țări, este foarte posibil să ai, la final, <strong>mai multe pensii</strong>:
      </p>

      <ul className="list-disc list-inside space-y-2">
        <li><strong>pensie din România</strong> – de la Casa Națională de Pensii;</li>
        <li><strong>pensii din străinătate</strong> – din Italia, Spania, UK, Germania, Austria, Belgia, Olanda, Franța etc.</li>
      </ul>

      <p>
        După întoarcere, toate aceste pensii pot fi plătite în România, în același cont bancar sau în conturi diferite, 
        în funcție de opțiunile fiecărui stat. Nu e obligatoriu să ai un cont separat pentru fiecare țară, 
        decât dacă instituția de pensii impune acest lucru.
      </p>
    </div>
    ...
    <div className="space-y-4">
      ...
      <div className="rounded-2xl bg-softBg border border-sky-100 p-5 text-sm space-y-3">
        ...
        <p>
          ...
          și pensie din Spania, pe care până acum o primea într-un cont spaniol.
        </p>

        <p className="font-semibold text-slate-900">Ce anunță</p>
        <ul className="list-disc list-inside space-y-1">
          <li>noua adresă din Botoșani, pentru toate comunicările oficiale;</li>
          <li>IBAN-ul din România, pentru plata pensiei spaniole;</li>
          <li>copia cărții de identitate din România, la cererea instituției spaniole.</li>
        </ul>

        <p className="font-semibold text-slate-900">Rezultat</p>
        <p>
          În 4–10 săptămâni, Spania actualizează datele și plata pensiei se face direct în contul din România.  
          Maria primește atât <strong>pensie din România</strong>, cât și <strong>pensie din Spania</strong> în același cont bancar.
        </p>
      </div>
    </div>
    ...
    <div className="rounded-2xl bg-white border border-slate-200 p-5 space-y-3">
      ...
      <p>
        Mutarea în România <strong>nu îți anulează dreptul la pensie din străinătate</strong> și nici la pensia comunitară.  
        Tot ce contează este să <strong>anunți corect și la timp schimbările</strong> de adresă și cont bancar și 
        să păstrezi bine toate deciziile și documentele.
      </p>
      <p>
        Dacă pregătești dosarul din timp, completezi formularele pentru Italia, Spania, UK, Germania sau alte state 
        și urmărești termenele pentru certificatul de viață, vei primi pensiile tale liniștit, în România, 
        fără întreruperi și fără surprize neplăcute.
      </p>
    </div>
          ...
          {/* 8. ÎNTREBĂRI FRECVENTE – VERSIUNE EXTINSĂ + OPTIMIZARE SEO */}
<section id="intrebari" className="bg-softBg">
  <div className="section-container py-10 lg:py-14 space-y-8 text-slate-800">

    <h2 className="text-2xl lg:text-3xl font-bold text-slate-900">
      8. Întrebări frecvente despre pensia în străinătate și pensia comunitară
    </h2>

    <p className="text-lg">
      Aici găsești răspunsuri clare, actualizate și explicate simplu la cele mai întâlnite întrebări 
      despre <strong>pensia din străinătate</strong>, <strong>pensia comunitară</strong>, 
      plata pensiei în România, certificatele de viață și procedurile administrative din Italia, Spania, UK, Germania, Austria, Belgia, Olanda și Franța.
    </p>
    ...
    <div className="space-y-6 text-sm">
      ...
      <div className="rounded-2xl border border-slate-100 bg-white p-5">
        ...
        <p>
          Da. Toate statele din UE și chiar și UK permit plata <strong>pensiei internaționale</strong> 
          în orice țară, inclusiv în România, dacă <strong>anunți noua adresă</strong> și, la nevoie, 
          <strong>noul cont bancar din România</strong>.
        </p>
        <p className="mt-2">
          Nu pierzi niciun drept doar pentru că te-ai mutat. Doar partea administrativă este esențială: 
          formular de schimbare adresă, certificat de viață, confirmare cont bancar.
        </p>
      </div>
      ...
      <div className="rounded-2xl border border-slate-100 bg-white p-5">
        ...
        <p>
          Da. Majoritatea statelor permit plata pensiei într-un <strong>IBAN din România</strong>, 
          indiferent dacă pensia provine din Italia, Spania, UK, Germania, Austria sau Belgia.
        </p>
        <p>Atenție la:</p>
        <ul className="list-disc list-inside mt-1 space-y-1">
          <li>comisioane bancare și conversie valutară pentru euro / lire / dolari;</li>
          <li>posibila întârziere de 1–2 zile la transfer;</li>
          <li>necesitatea unui extras de cont sau formular de actualizare IBAN.</li>
        </ul>
        <p className="text-slate-700 mt-2">
          Drepturile la <strong>pensie internațională</strong> nu se pierd prin schimbarea contului.
        </p>
      </div>
      ...
      <div className="rounded-2xl border border-slate-100 bg-white p-5">
        ...
        <p>
          Certificatul de viață este documentul pe baza căruia statul care îți plătește pensia 
          confirmă că ai în continuare dreptul la plată. Este obligatoriu pentru milioane de 
          pensionari din UE.
        </p>
        <p>
          Italia, Spania, Germania, UK și Franța cer cel mai des certificate de viață.
        </p>
        <p className="mt-2">Dacă nu îl trimiți la timp:</p>
        <ul className="list-disc list-inside space-y-1">
          <li><strong>plata se suspendă automat</strong>;</li>
          <li>nu pierzi banii, dar reactivarea poate dura 1–3 luni;</li>
          <li>trebuie trimis certificatul + o cerere de repunere în plată.</li>
        </ul>
      </div>
      ...
      <div className="rounded-2xl border border-slate-100 bg-white p-5">
        ...
        <p>În peste 80% dintre situații, motivul este unul dintre următoarele:</p>
        <ul className="list-disc list-inside space-y-1 mt-1">
          <li>certificat de viață netrimis;</li>
          <li>cont bancar schimbat sau închis;</li>
          <li>adresă neactualizată în Italia / Spania / Germania / UK;</li>
          <li>plată respinsă de banca din România.</li>
        </ul>

        <p className="mt-2 font-semibold">Pași recomandați:</p>
        <ol className="list-decimal list-inside space-y-1">
          <li>Verifică extrasul bancar (plată respinsă / returnată).</li>
          <li>Verifică dacă ai primit scrisori acasă în ultimele săptămâni.</li>
          <li>Suna la banca ta din România.</li>
      ...
      <div className="rounded-2xl border border-slate-100 bg-white p-5">
        ...
        <p>
          Da. Fiecare țară are propriul sistem și nu comunică automat cu celelalte.
        </p>
        <p>
          Dacă nu anunți:
        </p>
        <ul className="list-disc list-inside space-y-1 mt-1">
          <li>scrisorile (inclusiv certificatele de viață) ajung la vechea adresă;</li>
          <li>plățile pot fi respinse de bancă;</li>
          <li>pensia poate fi suspendată automat.</li>
        </ul>
      </div>
      ...
      <div className="rounded-2xl border border-slate-100 bg-white p-5">
        ...
        <p>
          Da. Dacă ai lucrat legal în România și în alte state, fiecare stat îți va plăti 
          partea lui de pensie conform <strong>regulilor de pensie internațională / pensie comunitară</strong>.
        </p>
        <p>Vei primi:</p>
        <ul className="list-disc list-inside space-y-1">
          <li>pensie din România;</li>
          <li>pensie din fiecare stat în care ai contribuit (Italia, Spania, UK, Germania etc.).</li>
        </ul>
        <p className="mt-2">
          Toate pot fi virate în același cont, dacă instituțiile permit.
        </p>
      </div>
      ...
      <div className="rounded-2xl border border-slate-100 bg-white p-5">
        ...
        <p>
          Situația este foarte des întâlnită. Poți folosi:
        </p>
        <ul className="list-disc list-inside space-y-1 mt-1">
          <li>consulatul sau ambasada pentru clarificări;</li>
          <li>traduceri automate pentru scrisorile primite;</li>
          <li>ajutorul unui membru al familiei;</li>
          <li>un serviciu specializat în pensii internaționale.</li>
        </ul>
      </div>
      ...
      <div className="rounded-2xl border border-slate-100 bg-white p-5">
        ...
        <p>
          Nimic complicat — trebuie doar să anunți noua adresă și, dacă este cazul, 
          <strong>noul cont bancar</strong>. Pensia internațională nu depinde de țara în care locuiești, 
          ci de faptul că instituția te poate contacta și îți poate vira în siguranță banii.
        </p>
      </div>
    ...
    <div className="rounded-2xl bg-white border border-slate-100 p-5 text-sm text-slate-700">
      <h3 className="font-semibold text-slate-900 mb-1">
        Concluzie: pensia din străinătate este sigură, dar necesită întreținere administrativă
      </h3>
      <p>
        Cât timp îți actualizezi adresa, contul bancar și trimiți certificatul de viață la timp,
        <strong>pensia din străinătate</strong> sau <strong>pensia comunitară</strong> va fi plătită fără probleme,
        indiferent în ce țară locuiești.
      </p>
      <p className="mt-2">
        Cu un minim de organizare, pensia ta rămâne stabilă, predictibilă și sigură.
      </p>
    </div>
